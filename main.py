...
if(model_active["active"]):
    ...
    from custom_tools import Execute_Tool_Function
    from tools.exit_chat import end_chat
...
def Chat_With_AI():
    ...
    while True:
        ...
        try:
            ...
            print("Your API key was reported as leaked! Please generate a new key from https://aistudio.google.com/app/api-keys and update it inside .env file!")
            break               
